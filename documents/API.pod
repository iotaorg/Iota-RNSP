...
Ponto de entrada de um determinado processo dentro do Discador VDT.
...
=item * /api/users/create

=item * /api/users/$id/edit

=item * /api/users/$id/delete
...
=item * /api/vars/create

=item * /api/vars/$id/edit

=item * /api/vars/$id/delete

=item * /api/vars/$id/populate
