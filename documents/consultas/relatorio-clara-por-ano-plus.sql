CREATE OR REPLACE FUNCTION public.func_status_indicadores_by_user_justificado_by_year_greater(
    abc integer,
    eixo integer,
...
select
    ...
    func_status_indicadores_by_user_justificado_by_year_greater(u.id, a.id,
        array(
...
copy _saida to '/tmp/status.indicadores.por-ano-plus.csv' CSV HEADER;