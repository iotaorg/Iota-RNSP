...
copy (select indicador_id, indicador_nome , sum(preenchido_2008) as preenchido_2008,sum(preenchido_2009) as preenchido_2009,sum(preenchido_2010) as preenchido_2010,sum(preenchido_2011) as preenchido_2011,sum(preenchido_2012) as preenchido_2012,sum(preenchido_2013) as preenchido_2013,sum(preenchido_2014) as preenchido_2014,sum(preenchido_2015) as preenchido_2015,sum(preenchido_2016) as preenchido_2016 from  _saida group by 1,2 order by 2) to '/tmp/preenchidos.por.ano.csv' csv header;