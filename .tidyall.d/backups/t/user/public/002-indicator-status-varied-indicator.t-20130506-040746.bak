...
eval {
    $schema->txn_do(
        sub {
            ...
            my $zero_status = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($zero_status, {
                status => [
                    {
                        id                    =>  $indicator->{id},
                        without_data          =>  1,
            ...
            $zero_status = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($zero_status, {
                status => [
                    {
                        id                    =>  $indicator->{id},
            ...
            my $without_data = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($without_data, {
                status => [
                    {
                        id                    =>  $indicator->{id},
                        without_data          =>  1,
           ...
           my $has_data = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($has_data, {
                status => [
                    {
                        id                    =>  $indicator->{id},
            ...
            my $has_current = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($has_current, {
                status => [
                    {
                        id                    =>  $indicator->{id},
                        without_data          =>  0,
            ...
            $without_data = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($without_data, {
                status => [
                    {
                        id                    =>  $indicator->{id},
            ...
            $has_current = &_get( 200, '/api/public/user/'.$Iota::TestOnly::Mock::AuthUser::_id.'/indicator/status' );
            is_deeply($has_current, {
                status => [
                    {
                        id                    =>  $indicator->{id},
