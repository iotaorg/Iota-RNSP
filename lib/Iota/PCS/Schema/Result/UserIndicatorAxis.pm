use utf8;
package Iota::PCS::Schema::Result::UserIndicatorAxis;
...
Related object: L<Iota::PCS::Schema::Result::UserIndicatorAxisItem>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G1XeByOQzF5oOPpms4qJEw
