use utf8;
package Iota::Schema::Result::AxisDim1;
...
=head1 TABLE: C<axis_dim1>

=cut

__PACKAGE__->table("axis_dim1");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2DwqUQXbF1Z6WPyXMi237g
