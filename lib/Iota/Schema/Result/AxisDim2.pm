use utf8;
package Iota::Schema::Result::AxisDim2;
...
=head1 TABLE: C<axis_dim2>

=cut

__PACKAGE__->table("axis_dim2");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C4lN2mAC2h92yxqvdtoDLA
