        ...
        create => Data::Verifier->new(
            ...
            profile => {
                ...
                axis_dim4_id => {
                    ...
                    post_check => sub {
                        my $r = shift;
                        return 1 if $r->get_value('axis_dim4_id') == '0';
                        my $axis =
...
sub action_specs {
    ...
    return {
        create => sub {
            ...
            $values{axis_dim4_id} = undef if defined $values{axis_dim4_id} && $values{axis_dim4_id} eq '0';
            ...
            if ( $formula->_variable_count ) {
                ...
                $var->update(
                  ...
                  if (!$var->period
                    || $var->period ne $anyvar->period
                    || !$var->variable_type
                    || $var->variable_type ne $vt );
            }
