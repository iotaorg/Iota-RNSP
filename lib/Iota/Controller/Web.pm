...
sub sugestao_bp_post : Chained('light_institute_load') PathPart('pagina/contato-boa-pratica_post') Args(0) {
    my ( $self, $c ) = @_;
...
sub sugestao_bp : Chained('light_institute_load') PathPart('pagina/contato-boa-pratica') Args(0) {
    my ( $self, $c ) = @_;
