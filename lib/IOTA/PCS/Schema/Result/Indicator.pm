use utf8;
package IOTA::PCS::Schema::Result::Indicator;
...
Related object: L<IOTA::PCS::Schema::Result::Axis>

=cut

__PACKAGE__->belongs_to(
  "axis",
  "IOTA::PCS::Schema::Result::Axis",
  { id => "axis_id" },
...
Related object: L<IOTA::PCS::Schema::Result::IndicatorNetworkConfig>
