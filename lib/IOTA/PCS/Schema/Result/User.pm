use utf8;
package IOTA::PCS::Schema::Result::User;
...
Related object: L<IOTA::PCS::Schema::Result::ActionsLog>

=cut

__PACKAGE__->has_many(
  "actions_logs",
  "IOTA::PCS::Schema::Result::ActionsLog",
...
Related object: L<IOTA::PCS::Schema::Result::IndicatorUserVisibility>

=cut

__PACKAGE__->has_many(
  "indicator_user_visibilities_created_by",
  "IOTA::PCS::Schema::Result::IndicatorUserVisibility",
...
Related object: L<IOTA::PCS::Schema::Result::Source>

=cut

__PACKAGE__->has_many(
  "sources",
  "IOTA::PCS::Schema::Result::Source",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::UserFile>

=cut

__PACKAGE__->has_many(
  "user_files",
  "IOTA::PCS::Schema::Result::UserFile",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::UserForgottenPassword>
...
Related object: L<IOTA::PCS::Schema::Result::UserIndicatorConfig>
...
Related object: L<IOTA::PCS::Schema::Result::UserIndicator>

=cut

__PACKAGE__->has_many(
  "user_indicators",
  "IOTA::PCS::Schema::Result::UserIndicator",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::UserRole>

=cut

__PACKAGE__->has_many(
  "user_roles",
  "IOTA::PCS::Schema::Result::UserRole",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::UserSession>

=cut

__PACKAGE__->has_many(
  "user_sessions",
  "IOTA::PCS::Schema::Result::UserSession",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::VariableValue>

=cut

__PACKAGE__->has_many(
  "variable_values",
  "IOTA::PCS::Schema::Result::VariableValue",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<IOTA::PCS::Schema::Result::Variable>

=cut

__PACKAGE__->has_many(
  "variables",
  "IOTA::PCS::Schema::Result::Variable",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
__PACKAGE__->might_have(
  "prefeito",
  "IOTA::PCS::Schema::Result::Prefeito",
  { "foreign.user_id" => "self.id", }
);

__PACKAGE__->might_have(
  "movimento",
  "IOTA::PCS::Schema::Result::Movimento",
  { "foreign.user_id" => "self.id" }
);
